...
import static modelo.Modelo.bgColorInboxButton;
import static modelo.Modelo.bgColorInboxPanel;
...
public class InboxWindow extends JFrame implements Windows {
    ...
    public void createButtons(int numButtons) {
        ...
        for (int i = 0; i < numButtons; i++)
            btn = new JButton(model.getINBOXWINDOWBTNSTXT()[i]);
    ...
    public void createPanels(int numPanels) {
            ...
            panel.setBackground(bgColorInboxPanel);
            panels.add(panel);
    }
    @Override
