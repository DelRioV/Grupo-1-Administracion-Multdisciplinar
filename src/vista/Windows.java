...
public interface Windows {
    ...
    //Method that create the different buttons
    public void createButtons(int numButtons);

    //Method that create the different panels
    public void createPanels(int numPanels);

    //Method that create the different TextFields
    public void createTextFields(int numTextFields);

    //Method that create the different Labels
